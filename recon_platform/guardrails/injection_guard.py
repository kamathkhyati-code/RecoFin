"""Prompt-injection guard (ported during A19 from Khyatis C17 work).
...
A19: this file, and its wiring into semantic_match_agent.py, already
existed on Khyatis intern-c branch (C17) at the time of this bug bash.
It had never been ported to the data-agent side (validation_agent.py's
ambiguous-row fallback, normalization_tools.py's entity_alias_tool) --
both of which also send untrusted transaction text to an LLM gateway.
Ported verbatim here; the data-agent wiring is new as of A19.
"""
